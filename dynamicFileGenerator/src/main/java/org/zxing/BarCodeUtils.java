...
// 编码内容, 编码类型, 宽度, 高度, 设置参数
    ...
    public static BufferedImage getBarCodeWithWords(String codeValue, String bottomStr) {
        return getBarCodeWithWords(codeValue, bottomStr, "", "",DEFAULT_BAR_CODE_WIDTH,DEFAULT_BAR_CODE_HEIGHT);
    }
    ...
    public static BufferedImage getBarCodeWithWords(String codeValue,
                                                    ...
                                                    int width,
                                                    int height) {
        return getCodeWithWords(getBarCodeImage(codeValue,width,height),
                bottomStr,
                topLeftStr,
                topRightStr,
